...
########################################################################################################
file_name='maindf_population_by_province_PAT.csv'
cvt={'CustomerCode':str}
...
mainDf.to_csv(file_path+'\\output\\'+'merged_Sales_711_SoS_Store_Population_R18_PopTambon_NoDupe.csv')
mainDf.to_excel(file_path+'\\output\\'+'merged_Sales_711_SoS_Store_Population_R18_PopTambon_NoDupe.xlsx', sheet_name='Sheet_name_1')
